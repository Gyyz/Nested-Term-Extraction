# -*- coding: utf-8 -*-
# @Author: Max     Date:   2018-01-19 11:33:37
# @Copy From: Jie Yang,     Contact: jieynlp@gmail.com
...
class Alphabet:
    ...
    def get_indexs(self, instances):
        if isinstance(instances, list):
            return [self.get_index(inst) for inst in instances]
        else:
            return self.get_index(instances)
    ...
    def get_instances(self, indexs):
        if isinstance(indexs, list):
            return [self.get_instance(idx) for idx in indexs]
        else:
             return  self.get_index(indexs)
    ...
    def save(self, output_directory, name=None):
        ...
        try:
            ...
            print("Exception: Alphabet is not saved: {}".format(repr(e)))
